...
// import GitLabIcon from "../../assets/img/gitlab-icon-color-black-rgb.svg";
import FormSection from "./FormSection";

const ContactSection = () => {
    const state = useSelector((state) => state.selectedData);
    const { title } = state.contactData;
    return (
        <div id="contact" className="pt-4 container">
